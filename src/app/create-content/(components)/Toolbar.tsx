  ...
  return (
    <div className="sticky top-0 z-20 bg-white dark:bg-zinc-950 border-b border-zinc-100 dark:border-zinc-800 p-2 flex items-center gap-1">
      ...
      <div className="flex items-center ml-auto pl-2 border-l border-zinc-200 dark:border-zinc-800 gap-3">
        {status === 'approved' ? (
          <button
            onClick={() => exportToDocx(title || "document", editor.getHTML())}
            className="flex items-center gap-2 px-4 py-1.5 text-xs font-bold uppercase tracking-tight text-white bg-emerald-600 rounded-lg hover:bg-emerald-700 transition-all shadow-sm cursor-pointer"
          >
