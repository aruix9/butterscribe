...
export function DocumentTable({ 
  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm min-h-[400px] flex flex-col">
                    ...
                    <td className="p-4 pl-6 w-1/2">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex flex-col min-w-0 flex-1">
                          <Link href={`/create-content/${doc._id}`} className="text-sm font-bold text-zinc-900 dark:text-white mb-1 truncate hover:text-primary transition-colors block">
                            {doc.title}
                          </Link>
